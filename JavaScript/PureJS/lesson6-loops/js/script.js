...
//     if (products[count].price < enterprice) {
//         console.log(`Title:${products[count].title} price: ${products[count].price}`);
//     }
// }
...
//         // console.log("Brand:"+car[i].brand+" Model:" + car[i].model);
//             console.log(`Brand:${car[i].brand} model:${car[i].model}`);
